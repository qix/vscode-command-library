...
export class Selection extends Range {
  ...
  constructor(
    selectionStartLineNumber: number | Position,
    selectionStartColumn: number | Position,
    positionLineNumber?: number,
    positionColumn?: number
  ) {
    if (
      selectionStartLineNumber instanceof Position &&
      selectionStartColumn instanceof Position
    ) {
      [
        ...
        selectionStartLineNumber.character,
        selectionStartColumn.line,
        selectionStartColumn.character
      ];
    }

    super(
      <number>selectionStartLineNumber,
      <number>selectionStartColumn,
      positionLineNumber,
      positionColumn
    );
    this.selectionStartLineNumber = <number>selectionStartLineNumber;
    this.selectionStartColumn = <number>selectionStartColumn;
